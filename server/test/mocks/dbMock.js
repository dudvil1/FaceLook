const userRepo = require('./sqlMock/userMock')
const baseRepo = require('./sqlMock/baseMock')
const postRepo = require('./sqlMock/postsMock')
const userFriendRepo = require('./sqlMock/userFriendMock')
